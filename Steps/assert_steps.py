...
def assert_status_code_200(response):
    with allure.step("Функцмя проверяет утверждение, что  status 200"):
        print(response)
...
def assert_status_code_404(response):
    with allure.step("Функцмя проверяет утверждение, что  status 404"):
        print(response)
...
def assert_not_none_id(response):
    with allure.step("Функцмя проверяет утверждение, что  id не пустой"):
        print(response)
...
def assert_equals_response_ids(first, second):
    with allure.step("Функцмя проверяет утверждение, что  id  в запросах равны"):
...
def assert_equals_response_names(first, second):
    with allure.step("Функцмя проверяет утверждение, что  name  в запросах равны"):
        print("first =", first.json())
        print("second =", second.json())
...
def assert_type_error(response):
    with allure.step("Функцмя проверяет утверждение, что  type равен error"):
        print(response)
...
def assert_type_unknown(response):
    with allure.step("Функцмя проверяет утверждение, что  type равен unknown"):
        print(response)
...
def assert_response_none(response):
    with allure.step("Функцмя проверяет утверждение, что  ответ пустой"):
        print(response)
